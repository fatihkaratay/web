...
function () {
  ...
  Model.prototype.save = function () {
    ...
    this.sync.save(this.attributes.getAll()).then(function (respose) {
      _this.trigger('save');
    }).catch(function () {
      _this.trigger('error');
    });
...
/** @class */
function () {
  function Collection(rootUrl, deserailze) {
    this.rootUrl = rootUrl;
    this.deserailze = deserailze;
    this.models = [];
  ...
  Collection.prototype.fetch = function () {
    ...
    axios_1.default.get(this.rootUrl).then(function (response) {
      response.data.forEach(function (value) {
        _this.models.push(_this.deserailze(value));
      });
...
userForm.render();
},{"./views/UserForm":"src/views/UserForm.ts","./models/User":"src/models/User.ts"}],"../../../../../../AppData/Roaming/npm/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
